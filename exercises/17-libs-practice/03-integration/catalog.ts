/**
 * The validation boundary you built in 17/02, provided here so this exercise
 * stands alone. You do not edit this file.
 *
 * `fetchProducts` and `fetchProduct` take a `TypedClient` — any `TypedClient`.
 * That is the seam 17/03 uses: hand them a client that caches and retries and
